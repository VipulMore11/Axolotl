...
const EVENT_TO_STAGE: Record<string, string> = {
  pipeline_failed: "workspace-setup",
  fetching_logs: "workspace-setup",
  workspace_setup: "workspace-setup",
  requirements_analysis: "requirements-analysis",
  technical_architecture: "technical-architecture",
  error_expansion: "error-expansion",
  ...
  generating_fix: "code-implementation",
  validating: "testing-validation",
  validation_passed: "testing-validation",
  validation_failed: "testing-validation",
  creating_branch: "git-operations",
  committing: "git-operations",
  creating_mr: "git-operations",
  waiting_approval: "approval",
}

/** All stage definitions in order */
const STAGE_DEFS: { key: string; label: string }[] = [
  { key: "workspace-setup", label: "Workspace Setup" },
  { key: "requirements-analysis", label: "Requirements Analysis" },
  { key: "technical-architecture", label: "Technical Architecture" },
  { key: "error-expansion", label: "Error Expansion" },
  { key: "task-breakdown", label: "Task Breakdown" },
  { key: "code-implementation", label: "Code Implementation" },
  { key: "testing-validation", label: "Testing & Validation" },
  { key: "code-review", label: "Code Review" },
  { key: "git-operations", label: "Git Operations" },
...
function wsEventToLogLine(ev: WSEvent): LogLine {
  ...
  const levelMap: Record<string, LogLine["level"]> = {
    ...
    fix_failed: "error",
    fetching_logs: "info",
    workspace_setup: "info",
    requirements_analysis: "info",
    technical_architecture: "info",
    error_expansion: "info",
    task_breakdown: "info",
    code_implementation: "info",
    testing_validation: "info",
    code_review: "info",
